...
result = clarifai_api.tag_images(open('/Users/Sean/Desktop/CApstone/clarifai_main/tests/data/octopus.jpg','rb'))
...
def main(argv):
  ...
  if len(argv) == 1:
    ...
    imageurl = 'http://energy.gov/sites/prod/files/styles/borealis_default_hero_respondlarge/public/door_5481543.jpg?itok=dIFozoNp'
